    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="primary" plain icon="el-icon-view" size="mini" :disabled="multipleSelection.length != 1"
              @click="handleView">查看流程图(带状态)</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" plain icon="el-icon-success" size="mini" :disabled="multipleSelection.length != 1"
              @click="handleAudit">审批/审核</el-button>
          </el-col>
        </el-row>
        <!-- 数据 -->
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="节点参数" align="left" prop="curTask">
            <template slot-scope="scope">
              <el-row>
                <el-col v-for="(item, index) in scope.row.curTask.formProperties" :key="index">
                  <el-link :href="item.name" type="primary" target="_blank">{{ item.id }}-{{ item.name }}</el-link>
                </el-col>
              </el-row>
            </template>
          </el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="检定时间" prop="ver_date">
              <el-date-picker style="width:100%" v-model="formJD.ver_date" type="date"
                placeholder="请输入检定时间"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="有效期" prop="ver_valid_until">
              <el-date-picker style="width:100%" v-model="formJD.ver_valid_until" type="date"
                placeholder="请输入有效期"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
